/**
 * Haftalık Karma — UBGT / yıllık izin düşümünde gün başına düşülecek net saat stratejisi.
...
/**
 * @param groupNetDailiesInOrder dayGroups sırasıyla her grubun net günlük süresi (geçersiz grup → 0).
 * Düşüm günü başına haftalık netten çıkarılacak saat (takvim/slot eşlemesi yok).
 */
