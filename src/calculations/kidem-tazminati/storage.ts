/**
 * Kıdem Tazminatı - ekstra hesaplama setleri (API)
 */
...
export async function saveExtraCalculationsSet(name: string, data: Array<{ id: string; name: string; value: string }>): Promise<boolean> {
  try {
