/**
 * İş Kanununa göre yıllık ücretli izin (v1 StandartIndependent ile uyumlu mantık, v2 shell).
 */
...
const REPORT_CONTENT_ID = "report-content-yillik-standart";
...
export default function YillikIzinStandartPage() {
  ...
  useEffect(() => {
    const run = async () => {
      try {
        ...
        const response = await apiClient("/api/yillik-izin/standart", {
          method: "POST",
    ...
    <div className="min-h-[calc(100vh-4rem)] w-full bg-gray-50 dark:bg-gray-900 pb-28">
      ...
      <div className="w-full py-3 sm:py-4 px-3 sm:px-4">
        ...
        <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm overflow-hidden">
          <div className="p-4 sm:p-6 space-y-5">
            ...
            <div className="p-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900/20">
              <div className="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-2">Yıllık İzin Hak Edişi</div>
        ...
        <div className="mt-6 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 sm:p-5 shadow-sm">
          ...
          <p className="text-xs font-semibold text-gray-800 dark:text-gray-200 mb-2">Not: İş Kanunu – Yıllık İzin</p>
