...
/** İşe girişe hizalı 7 günlük kova anahtarı (groupWeeks24 ile aynı). Zorunlu düşüm gruplaması için. */
...
export type GroupWeeks24Options = {
...
/**
 * 24/24: haftalık çalışma günü × 3 = haftalık FM saati.
 ...
 */
export function groupWeeks24(workDays: WorkDay[], opts?: GroupWeeks24Options): Weekly24Row[] {
